...
(define (poke! vec idx val)
  (cond [(<= idx (vector-length vec)) (vector-set! vec idx val)]
...
(define (day9-p1)
  ((functionize input 'p1) 1))

(check-equal? (time (day9-p1)) 2427443564) ; answer for part 1

(define (day9-p2)
  ((functionize input 'p2) 2))

(check-equal? (time (day9-p2)) 87221) ;; answer for part 2
